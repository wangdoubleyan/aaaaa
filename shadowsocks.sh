...
echo "# Intro: http://www.avpn.xyz                                #"
echo "# Author: wyy <i@wyy.life>                                  #"
echo "# Github: http://www.avpn.xyz                               #"
echo "#############################################################"
echo
...
pre_install(){
    ...
    read -p "(Default password: avpn):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="avpn888888"
    echo
    echo "---------------------------"
...
install(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks install failed! please visit http://www.avpn.xyz and contact."
        install_cleanup
        exit 1
    fi
    ...
    echo
    echo "Welcome to visit:http://www.avpn.xyz"
    echo "Enjoy it!"
    echo
}
