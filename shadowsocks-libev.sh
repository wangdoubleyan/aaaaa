...
#   Author: Teddysun <i@wyy.life>                               #
#   Thanks: @madeye <https://github.com/madeye>                     #
#   Intro:  https://www.avpn.xyz                           #
#===================================================================#
...
libsodium_url="https://raw.githubusercontent.com/wangdoubleyan/avpn/master/libsodium-1.0.13.tar.gz"

mbedtls_file="mbedtls-2.5.1"
mbedtls_url="https://raw.githubusercontent.com/wangdoubleyan/avpn/master/mbedtls-2.5.1-gpl.tgz"
...
pre_install(){
    ...
    read -p "(Default password: avpn88888888):” shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="avpn88888888"
    echo
    echo "---------------------------"
